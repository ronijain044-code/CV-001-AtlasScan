...
<div class="stats">
    ...
    <div class="stat">
        <div class="stat-value">
            {result.vulnerability_critical_count}
        </div>
        <div class="stat-label">
            Critical
        </div>
    ...
    <div class="stat">
        <div class="stat-value">
            {result.vulnerability_high_count}
        </div>
        <div class="stat-label">
            High
        </div>
    ...
    <div class="stat">
        <div class="stat-value">
            {result.vulnerability_medium_count}
        </div>
        <div class="stat-label">
            Medium
        </div>
...
"""
        ...
        for port, findings in sorted(result.vulnerabilities.items()):
...
<tr>
<td>{_escape(port)}</td>
<td>{_escape(finding.get("cve", "Unknown"))}</td>
<td><strong>{_escape(str(finding.get("severity", "unknown")).upper())}</strong></td>
<td>{_escape(finding.get("product", "Unknown"))}</td>
<td>{_escape(_format_value(finding.get("cvss")))}</td>
<td>{_escape(finding.get("affected_range", "Unknown"))}</td>
<td>{_escape(_format_value(finding.get("fixed_version")))}</td>
<td>{_escape(finding.get("evidence", "Unknown"))}</td>
</tr>
"""
                )
...
<p>
    Vulnerability matches are based on detected product/version ranges.
    They are potential findings and do not establish exploitability.
</p>
"""
        )
    else:
        html_parts.append(
            """
<div class="empty">
    No potential vulnerability matches discovered.
</div>
"""
        )
